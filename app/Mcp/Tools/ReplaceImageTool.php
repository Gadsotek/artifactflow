...
#[Name('replace_image')]
#[Description('Append normalized PNG/JPEG pixels to an editable image page with version concurrency.')]
final class ReplaceImageTool extends ArtifactFlowTool
{
    ...
    public function schema(JsonSchema $schema): array
    {
        return [
            ...
            'change_summary' => $schema->string()
                ->description('Required concise summary of what changed in this image version, up to 255 characters.')
                ->required(),
