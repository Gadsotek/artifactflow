    ...
    public function __invoke(
        ...
        return response()
            ->json(['url' => match ($page->type) {
                PageType::Pdf => $pdfArtifactUrl->temporaryCurrentUrl($page, $version),
                PageType::Docx => $docxPreviewUrl->temporaryCurrentUrl($page, $version),
                default => $previewUrl->temporaryUrl($page, $version),
            }])
