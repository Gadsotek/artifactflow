...
- Default-off PDF milestone: the public [architecture and security decision](docs/architecture/pdf-artifacts.md) defines its reviewable boundary. Supporting product, delivery, and spike records remain private working material. The application boundary is implemented, but production enablement and shipped support remain gated.
