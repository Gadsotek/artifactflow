...
{
    public function test_create_update_organize_upload_and_share_scopes_are_write_scopes(): void
    {
        ...
        $this->assertTrue(McpAccessTokenIssuer::includesWriteScope([McpAccessTokenIssuer::SCOPE_ORGANIZE]));
        $this->assertTrue(McpAccessTokenIssuer::includesWriteScope([McpAccessTokenIssuer::SCOPE_UPLOAD]));
