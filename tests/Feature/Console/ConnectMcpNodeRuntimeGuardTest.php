...
{
    private const string LOCK_SHA256 = '961573fdb327c6c7ba78d654a523a51054897b68f5f49034bc57b5e1df997ea4';
    ...
    public function test_codex_only_configuration_uses_the_integrity_locked_stdio_bridge(): void
    {
        ...
        $bridgeEntrypoint = $home . '/.local/share/artifactflow/mcp-remote/0.8.5-'
    ...
    public function test_claude_config_runs_the_integrity_locked_bridge_through_absolute_paths(): void
    {
        ...
        $this->assertSame(0, $process->getExitCode(), $process->getErrorOutput());
        $bridgeHome = $home . '/.local/share/artifactflow/mcp-remote/0.8.5-' . self::LOCK_SHA256;
        ...
        $this->assertSame('0.8.5', $dependencies['mcp-remote'] ?? null);
        $this->assertStringContainsString(
            'sha512-2A3MbXL0iyR4hP8VomEGdoLeD1wyyrgBhD+scyr3vqf4QWeiEKSJewvTnhhW1gHEGvdLltCFBXyoHa+uVMXGQg==',
            $lock,
        );
    ...
    {
        $script = $this->modifiedConnector([
            'MCP_REMOTE_VERSION="0.8.5"' => 'MCP_REMOTE_VERSION="9.8.7"',
        ]);
